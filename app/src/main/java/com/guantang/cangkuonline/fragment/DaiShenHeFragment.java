...
public class DaiShenHeFragment extends Fragment implements IXListViewListener,DDfilterInterface{
...
//		sqtotime = formatter.format(System.currentTimeMillis());
	...
	class GetDDInfo_1_0AsyncTask extends AsyncTask<String,Void,String>{
		...
		protected String doInBackground(String... params) {
			// TODO 自动生成的方法存根
			String jsonString = WebserviceImport_more.GetDDInfo_1_0("NotAuditedInfo", params[0], "10", params[1], params[2], params[3], "-1");
			return jsonString;
		}
		@Override
	...
	public void parseData(JSONObject jsonObject) throws JSONException{
		...
		JSONObject NotAuditedInfojsonObject = dataJSONObject.getJSONObject("NotAuditedInfo");
		JSONArray dsJSONArray = NotAuditedInfojsonObject.getJSONArray("ds");
